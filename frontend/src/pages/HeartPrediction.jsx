...
export default function HeartPrediction() {
  ...
  const inputFields = [
    ...
    { name: 'sex', label: 'Sex' },
    { name: 'cp', label: 'Cp' },
    { name: 'trestbps', label: 'Trestbps' },
    { name: 'chol', label: 'Chol' },
    { name: 'fbs', label: 'Fbs' },
    { name: 'restecg', label: 'Restecg' },
    { name: 'thalach', label: 'Thalach' },
    { name: 'exang', label: 'Exang' },
    { name: 'oldpeak', label: 'Oldpeak' },
    { name: 'slope', label: 'Slope' },
    { name: 'ca', label: 'Ca' },
    { name: 'thal', label: 'Thal' },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-100 to-purple-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-xl overflow-hidden">
        <div className="px-4 py-5 sm:p-6">
          <h2 className="text-3xl font-extrabold text-gray-900 text-center mb-6">Heart Disease Prediction</h2>
